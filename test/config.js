...
describe('Configuration mechanism', () => {
  ...
  describe('Default values', () => {
    ...
    let configs = [
      ...
      {l: "mqtt clientId", k: (c) => c.mqtt.client.id, v: "channel-manager"},
      {l: "mqtt topic", k: (c) => c.mqtt.topic.in, v: "decide/+/+"},
      {l: "mqtt topic", k: (c) => c.mqtt.topic.out, v: "notify/__TYPE__/__CLIENT_ID__/__CORRELATION_ID__"},
